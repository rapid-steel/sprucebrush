...
export default class Brush extends ToolWebGL {
        ...
        .join("\n") +`
            ...
            void main(void) { 
                ...
                hsldelta = vec3(0.0, 0.0, 0.0);                   
                    ...
                    hsldelta.y = dynamics_periodic(1.0, saturation_dynr, linePos, saturation_dynlen); 
                #elif SATURATIONDYNAMICS == 3
                    hsldelta.y = dynamics_pressure(1.0, saturation_dynr, pressure); 
                #elif SATURATIONDYNAMICS == 6
                    hsldelta.y = dynamics_random(1.0, saturation_dynr, gl_Position.xy, index, 4.0);
                #endif

                #if LIGHTNESSDYNAMICS == 2
                    hsldelta.z = dynamics_periodic(1.0, lightness_dynr, linePos, lightness_dynlen); 
                #elif LIGHTNESSDYNAMICS == 3
                    hsldelta.z = dynamics_pressure(1.0, lightness_dynr, pressure); 
                #elif LIGHTNESSDYNAMICS == 6
                    hsldelta.z = dynamics_random(1.0, lightness_dynr, gl_Position.xy, index, 4.0);
                #endif
    ...
    createFragShader(props) {
        ...
        ${this.commonCodeBlocks.color_func}
